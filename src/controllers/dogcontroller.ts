...
const createdogdata = async (req: Request, res: Response) => {
    try {
...
const getdogdata = async (req: Request, res: Response) => {
    try {
...
const updatedogdata = async (req: Request, res: Response) => {
    try {
...
const deletedogdata = async (req: Request, res: Response) => {
    try {
        const userid = req.params.id
